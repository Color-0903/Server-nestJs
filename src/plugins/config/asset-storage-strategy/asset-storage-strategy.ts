...
export interface AssetStorageStrategy extends InjectableStrategy {
   ...
   * file such as a file path or a URL.
   */
  writeFileFromBuffer(fileName: string, data: Buffer, mimetype?: string): Promise<string>;
   ...
   * file such as a file path or a URL.
   */
  writeFileFromStream(fileName: string, data: Stream, mimetype: string): Promise<string>;
