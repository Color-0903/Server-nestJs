...
export class RemoveColumn1730640967210 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`banner\` ADD \`lastModifiedByUserId\` varchar(255) NULL`,
    );
    await queryRunner.query(`ALTER TABLE \`banner\` ADD \`createdByUserId\` varchar(255) NULL`);
    await queryRunner.query(
      `ALTER TABLE \`order_detail\` ADD \`lastModifiedByUserId\` varchar(255) NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`order_detail\` ADD \`createdByUserId\` varchar(255) NULL`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`voucher\` ADD \`lastModifiedByUserId\` varchar(255) NULL`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`product\` ADD \`lastModifiedByUserId\` varchar(255) NULL`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`category\` ADD \`lastModifiedByUserId\` varchar(255) NULL`,
    );
