...
export class AddStore1730643032207 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`voucher\` ADD CONSTRAINT \`FK_225591a8f647c953baf6bf19a7c\` FOREIGN KEY (\`storeId\`) REFERENCES \`store\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`voucher\` DROP FOREIGN KEY \`FK_225591a8f647c953baf6bf19a7c\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`store\` DROP FOREIGN KEY \`FK_2dea3b5a3f835981b73f155af83\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`store\` DROP FOREIGN KEY \`FK_3f82dbf41ae837b8aa0a27d29c3\``,
    );
