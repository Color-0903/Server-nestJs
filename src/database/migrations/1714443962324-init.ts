...
export class Init1714443962324 implements MigrationInterface {
    name = 'Init1714443962324'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` varchar(36) NOT NULL, \`createdOnDate\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`createdByUserId\` varchar(255) NULL, \`lastModifiedOnDate\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`lastModifiedByUserId\` varchar(255) NULL, \`deletedAt\` datetime(6) NULL, \`identifier\` varchar(255) NOT NULL, \`type\` varchar(255) NOT NULL DEFAULT 0, \`passwordHash\` varchar(255) NOT NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`verified\` tinyint NOT NULL DEFAULT 0, \`lastLogin\` datetime NULL, \`assetId\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
